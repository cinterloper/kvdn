...
class IgniteDataImpl extends IgniteExtension implements KVData {
    ...
    void getMap(String s, Handler<AsyncResult<AsyncMap>> handler) {
        CacheConfiguration cacheconfig = this.cacheConfigLookup(s)
        IgniteCache<String, Object> asyncCache = ignite.getOrCreateCache(cacheconfig) as IgniteCache<String, Object>
