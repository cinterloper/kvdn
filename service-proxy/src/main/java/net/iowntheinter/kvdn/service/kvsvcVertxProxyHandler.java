  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "set": {
          service.set((JsonObject)json.getValue("document"), createHandler(msg));
          break;
        }
        case "submit": {
          service.submit((JsonObject)json.getValue("document"), createHandler(msg));
          break;
        }
        case "get": {
        ...
        case "getKeys": {
          service.getKeys((JsonObject)json.getValue("document"), createHandler(msg));
          break;
        }
        case "delete": {
          service.delete((JsonObject)json.getValue("document"), createHandler(msg));
          break;
        }
        default: {
